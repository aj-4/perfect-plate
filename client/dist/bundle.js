...
var Measurement = function Measurement(_ref) {
    var name = _ref.name,
        img = _ref.img;
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement('img', { src: img, alt: name })
    );
};
...
var _measurement = __webpack_require__(15);
...
var _measurementList = __webpack_require__(29);

var _measurementList2 = _interopRequireDefault(_measurementList);

var _selectedItem = __webpack_require__(30);

var _selectedItem2 = _interopRequireDefault(_selectedItem);

var _savedList = __webpack_require__(31);
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        key: 'formatName',
        value: function formatName(itemObj) {
            var firstLetter = itemObj.name[0].toUpperCase();
        ...
        value: function submitSearch(e) {
            ...
            fetch('/api', {
                ...
                return console.log(err, 'Error in submitSearch');
            });
        }
    }, {
        key: 'addToList',
...
var Search = function (_React$Component) {
    ...
    _createClass(Search, [{
        ...
        key: 'render',
        value: function render() {
            var getFood = this.props.getFood;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', { className: 'search-food', onChange: this.handleChange.bind(this), type: 'text', placeholder: 'Find a Food' }),
                    _react2.default.createElement(
                        'button',
...
var MeasurementList = function MeasurementList(_ref) {
    ...
    return _react2.default.createElement(
        ...
        macros.map(function (macro) {
            console.log(macro);
            _react2.default.createElement(_measurement2.default, { img: macro.img, name: macro.name, val: '0' });
        })
    );
};

exports.default = MeasurementList;
...
var SavedList = function SavedList(_ref) {
    ...
    var allItems = listItems.map(function (itemData) {
        return _react2.default.createElement(
            'div',
            { className: 'list-item-div', key: itemData.name },
            _react2.default.createElement(_listItem2.default, { itemData: itemData })
        );
    });
    return _react2.default.createElement(
        'div',
